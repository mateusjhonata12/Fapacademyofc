...
import { GraduationCap, ShieldCheck, Award, Trophy } from 'lucide-react';
  ...
  ({ certificate, userName }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Detalhes de Cantos Institucionais (Cantoneiras Douradas) */}
        ...
        <div className="relative z-10 flex items-center justify-between border-b pb-5" style={{ borderColor: '#E2E8F0' }}>
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border shrink-0" style={{ backgroundColor: '#F8FAFC', borderColor: '#E2E8F0' }}>
            {isFinancas ? <Trophy size={20} style={{ color: '#059669' }} /> : <Award size={20} style={{ color: '#D97706' }} />}
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center my-3 px-8">
          ...
          <h1 className="text-3xl font-black uppercase mb-2" style={{ color: '#0F172A', letterSpacing: '2px' }}>
            {isFinancas ? 'FORMAÇÃO EM SISTEMAS FINANCEIROS' : 'CERTIFICADO DE CONCLUSÃO'}
          </h1>
          <div className="w-36 h-1 rounded-full mb-6" style={{ background: 'linear-gradient(to right, #F59E0B, #3B82F6, #10B981)' }} />
          ...
          {/* Texto Específico conforme Especificação #13 */}
          <div className="max-w-3xl text-sm leading-relaxed font-normal" style={{ color: '#334155', letterSpacing: '0px' }}>
            {is7Edu && (
              <p style={{ lineHeight: '1.8' }}>
                ...
                , desenvolvido pela Faculdade Adventista do Paraná, por meio da plataforma FAP Academy.
              </p>
            )}
            ...
            {isFinancas && (
              <p style={{ lineHeight: '1.8' }}>
                concluiu com êxito a formação do módulo completo de{' '}
                <span className="font-extrabold uppercase text-base px-2.5 py-1 rounded border inline-block mx-1 align-baseline" style={{ color: '#064E3B', backgroundColor: '#D1FAE5', borderColor: '#6EE7B7', letterSpacing: '0.5px' }}>
                  FORMAÇÃO EM SISTEMAS FINANCEIROS
                </span>
                , abrangendo os treinamentos dos sistemas 7Edu e TOTVS, por meio da plataforma FAP Academy.
              </p>
            )}
          </div>
        </div>
        ...
        <div className="relative z-10 pt-4 border-t grid grid-cols-3 items-end gap-6 text-center" style={{ borderColor: '#E2E8F0' }}>
          ...
          <div className="text-left pl-2">
            ...
            <p className="text-[11px] font-bold mt-1.5 flex items-center gap-1" style={{ color: '#059669' }}>
              <ShieldCheck size={14} className="shrink-0" style={{ color: '#059669' }} />
              Finanças / Faculdade Adventista do Paraná
            </p>
          </div>
